    ...
    return (
      <ScrollView contentContainerStyle={{ flexGrow: 1}}>
        ...
        <View style={styles.articleText}>
          ...
          />
          <Button title = "Learn More" style={{paddingTop: 5, paddingBottom: 5}} onPress={()=>navigate('MonthlyNews')}/>
        </View> 
        ...
        <Divider style={{backgroundColor: 'black', height:1.5, marginBottom:10, maxWidth:150, marginLeft: 138}}/>
        <Image source = {COVID19Impacts} style = {{width:305, height: 320, alignSelf: 'center', marginBottom:5, borderColor: 'black', borderWidth: 1}}/>
        <View style={styles.articleText}>
          <Description 
          ...
          />
          <Button title = "Learn More" style={{paddingTop: 5, paddingBottom: 5}} onPress={()=>navigate('COVID19Impacts')}/>
        </View>
